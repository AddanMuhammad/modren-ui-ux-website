const testimonials = [
  {
    ...
    content:
      "This AI-powered development platform has revolutionized how we write code. This intelligent suggestions save us hours every day.",
  },
  {
    ...
    content:
      "The collaboration features and smart insights have dramatically improved our team’s productivity and communication.",
  },
  {
    name: "Aisha Patel",
    role: "UX Designer",
    ...
    content:
      "I love how intuitive and responsive the platform is. It helps bridge the gap between design and development seamlessly.",
  },
];
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="lg:w-1/2 w-full text-center lg:text-left">
            ...
            <p className="text-gray-400 text-xl sm:text-lg max-w-2xl mx-auto ">
              Eveything you need to build, test and deploy application with
